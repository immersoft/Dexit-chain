...
/**********************Slashing**********************/
      function punish(address validator) 
        external 
        override  {
...
//Function to distribute reward income 
    function distributeRewardIncomeExcept(address validator, uint256 income) private    
    {
        uint256 index;
        ...
        if (averageDistribute != 0) {
            for (uint256 i = 0; i < index; i++) {
                validatorInfo[currentValidators[i]].income = validatorInfo[currentValidators[i]].income.add(averageDistribute);
            }
