...
if (window.ethereum) {
  const bscValidatorAddress= "0x0000000000000000000000000000000000001000";
  // const bscValidatorAddress= "0xc006248d63d258Ae4E47d11aCF242C1e5E958c4f";
  
  const bscValidatorAbi=[
		{
			"anonymous": false,
			"inputs": [
				{
		...
		},
		{
			...
			"name": "removeFromHighestValidatorList",
			"outputs": [],
			"stateMutability": "nonpayable",
			"type": "function"
		},
  ...
  var web = new ethers.Contract(bscValidatorAddress, bscValidatorAbi, signer);
}
export default web;