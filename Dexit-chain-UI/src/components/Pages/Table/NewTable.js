import { Box, Card, Button, Paper, Table, TableBody, TableCell, TableContainer,  TableRow, Typography, TextField, Tabs, Tab } from '@mui/material'
...
const NewTable = () => {
  ...
  return (
    ...
    <Card sx={{ display: 'flex',p:2 ,flexDirection:'column',background:"#F8F9FA"}}>
        <ArrowBackIcon onClick={handleChangeState} fontSize="large" sx={{cursor:"pointer", boxShadow: 1 ,borderRadius:"11px",backgroundColor:"white",padding:"0px 2px"}}/>
        <Box sx={{ flexGrow: 1 }}>
